class Product < ActiveRecord::Base
  attr_accessible :title,:fair_trade,:non_profit_cause, :user_id,:status,:agree_terms, :description, :price, :colors_attributes, :images_attributes,:category_id, :color, :discount,:qty, :qty_sold, :non_profit_percentage
  belongs_to :user
  belongs_to :category
  ...
  accepts_nested_attributes_for :images, :colors, :allow_destroy => true, :reject_if => :all_blank

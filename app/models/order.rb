class Order < ActiveRecord::Base
  ...
  def set_payments_and_dates
    ...
    self.non_profit_payment = (self.line_item.full_price.to_i-self.admin_payment.to_i)/self.line_item.product.non_profit_percentage if self.line_item.product.non_profit_percentage.present?

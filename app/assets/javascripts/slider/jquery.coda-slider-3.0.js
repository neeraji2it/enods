...
(function($, window, document, undefined) {
    var Slider = {
        ...
        init: function(options, elem) {
            ...
            $('.coda-slider').prepend('<p class="loading">Loading...<br /><img src="/assets/bigger_spinner.gif" width="220" height="19" alt="loading..." /></p>');
        ...
        build: function() {
            ...
            if (self.options.autoHeight) {
                $(self.sliderId).css('height', $($(self.panelContainer).children()[self.currentTab]).height() + $(self.sliderId + '-wrapper .coda-nav-right').height());
            }
        ...
        alignNavigation: function() {
            ...
            if (self.options.dynamicTabsAlign != 'center') {
                ...
                if ($.browser.msie) {
                    self.totalNavWidth = self.totalNavWidth + (5);
                } // Simple IE fix
